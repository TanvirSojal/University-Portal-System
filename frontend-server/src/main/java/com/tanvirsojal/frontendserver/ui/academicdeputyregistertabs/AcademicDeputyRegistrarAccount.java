...
public class AcademicDeputyRegistrarAccount extends VerticalLayout {
    public AcademicDeputyRegistrarAccount(UserService userService, AuthenticationService authenticationService,  HttpSession httpSession) {
