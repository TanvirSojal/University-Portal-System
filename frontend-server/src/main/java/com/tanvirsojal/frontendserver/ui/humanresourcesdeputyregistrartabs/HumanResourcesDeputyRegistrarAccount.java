...
public class HumanResourcesDeputyRegistrarAccount extends VerticalLayout {
    public HumanResourcesDeputyRegistrarAccount(UserService userService, AuthenticationService authenticationService, HttpSession httpSession) {
