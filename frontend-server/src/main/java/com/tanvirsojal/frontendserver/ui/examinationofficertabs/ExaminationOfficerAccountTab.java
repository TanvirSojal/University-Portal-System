...
public class ExaminationOfficerAccountTab extends VerticalLayout {
    public ExaminationOfficerAccountTab(UserService userService, AuthenticationService authenticationService, HttpSession httpSession) {
