...
public class AdmissionOfficerAccountTab extends VerticalLayout {
    public AdmissionOfficerAccountTab(UserService userService, AuthenticationService authenticationService, HttpSession httpSession) {
